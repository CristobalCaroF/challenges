...
const catStartingFromIndexFiveExists = Boolean(
  animalStrings.find(function (animal) {
    animal === "cat";
  }, 5)
);
...
const anyAnimalEndsWithLetterZ = Boolean(
  animalStrings.find((animal) => animal.endsWith("z"))
);
