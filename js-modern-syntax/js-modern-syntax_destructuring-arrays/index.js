...
export const [student1, students2, students3] = nestedStudents;
export const [student2, student3] = students2;
export const [student4, student5] = students3;
...
export function reverseArrayWithoutMutating(arr) {
  ...
  const arrReversed = [value3, value2, value1];
  return arrReversed;
}
...
export function mergeAndSortArrays(array1, array2) {
  ...
  const sortedAray = array3.slice().sort((a, b) => a - b);
  return sortedAray;
}
