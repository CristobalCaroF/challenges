...
console.log("Other friends of Homer: ", homersOtherFriends);
...
console.log("Age of third person (Bart): ", ageOfThirdPerson);
...
console.log(
  "Mothers name of second person (Marge): ",
...
console.log("Type of animal of Lisas pet: ", animaltypeOfLisasPet);
